...
public class HealCube : MonoBehaviour
{
    ...
    public static int pointsForKill = 1200; //Количество очков за попадание по кубу исцеления
    public static int heal = 25; //Количество очков здоровья, восстанавливаемое игроку
